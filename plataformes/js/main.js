...
function preload() {
    ...
    this.load.spritesheet('tiles', '/plataformes/assets/tiles.png', {frameWidth: 70, frameHeight: 70});
    // simple coin image
    this.load.image('coin', '/plataformes/assets/coinGold.png');
    // player animations
    this.load.atlas('player', '/plataformes/assets/player.png', '/plataformes/assets/player.json');
}
